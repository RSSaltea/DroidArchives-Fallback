...
assert.equal(run("normaliseNotificationPreferences({startRebirth:99,cycles:'bad'}).startRebirth"),40);assert.equal(run("normaliseNotificationPreferences({startRebirth:0,cycles:'bad'}).cycles"),'current');
