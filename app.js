...
function blankProfileData(){return{owned:[],blueprints:[],droidex:[],novaUpgrades:{},cantinaPurchases:{},multiplier:1,cycle:0,rebirth:0,superRebirthGoal:35,protocolPriority:'credits',optimiseFreeBuild:false,optimiseFuseFirst:true,fusionAsLounge:false,optimiseFreeBuildMode:'upgrade-cost',optimiseKeepDroidex:true,autoCompleteBuilds:false,companionGoals:null,preferredCompanions:[],autoPurchaseSlots:true,purchasedSlots:[],loungePurchased:0,novaLevel:0,rebirthTracker:{notUsingBase:false,entries:{}}}}
...
function protocolRegionSlots(region,renderStation){return `<div class="protocol-region-slots">${renderStation(`PROTOCOL_${region}_CREDITS`)}${renderStation(`PROTOCOL_${region}_CRAFTING`)}</div>`;}
